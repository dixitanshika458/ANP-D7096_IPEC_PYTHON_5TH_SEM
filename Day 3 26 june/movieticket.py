#A multiplex allows entry to a movie only if the customer is 18 years of age or older. Write a Python program that accepts the age of a customer and determines whether they are eligible to watch the movie. 
